  ...
  return (
    ...
    >
      ...
      >
        ...
        <p className="text-center mb-16 max-w-2xl mx-auto" style={{ color: "var(--color-text-soft)" }}>
        ...
        <div className="flex flex-col lg:flex-row items-center justify-center gap-8 lg:gap-4">
          ...
          >
            <p className="font-bold" style={{ color: "var(--color-text-soft)" }}>Estilo Clásico</p>
          </div>
          ...
          <div
            ...
            style={{ background: "var(--color-surface)", border: "1px solid var(--color-surface-2)" }}
          >
            <p className="font-bold" style={{ color: "var(--color-text-soft)" }}>Estilo Minimalista</p>
          </div>
        </div>
      </motion.div>
    </section>
